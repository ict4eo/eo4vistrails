...
class CsvFilter(ThreadSafeMixin, Module):
    ...
    def compute(self):
        ...
        #print "csvutils.461: ", cols_list, rows_list
        if not header_in:
        ...
        if filename:
            try:
                ...
                #print "csvutils.516: lists_0", list_of_lists
