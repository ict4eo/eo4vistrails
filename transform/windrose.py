...
__notes__ = "Small grammar changes made to ensure PEP8 compliance"
...
RESOLUTION = 100
ZBASE = -1000  # Starting zorder for all drawing, negative to have the grid on
...
class WindroseAxes(PolarAxes):
    ...
    def legend(self, loc='lower left', **kwargs):
        ...
        pad = 0.2            # fractional whitespace inside the legend border
