...
MOCK_MODULES = ['h5py', 'geojson', 'gdal', 'gdalnumeric',
                ...
                'packages.eo4vistrails.geoinf.ogc',
                'packages.eo4vistrails.geoinf.ogc.Common',
                'packages.eo4vistrails.geoinf.ogc.OgcService',
                'packages.eo4vistrails.geoinf.ogc.SOS',
                'packages.eo4vistrails.geoinf.ogc.WCS',
                'packages.eo4vistrails.geoinf.ogc.WFS',
                'packages.eo4vistrails.geoinf.ogc.WPS',
                'packages.eo4vistrails.geoinf.ogc.PortConfigurationWidget',
